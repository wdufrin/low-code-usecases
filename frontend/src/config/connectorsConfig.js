...
export const ALL_CONNECTORS = [
  ...
  { 
    id: 'github', name: 'GitHub', icon: Github, color: '#24292e', enabled: true,
  ...
  { 
    id: 'slack', name: 'Slack', icon: MessageSquare, color: '#4A154B', enabled: true,
  ...
  { 
    id: 'box', name: 'Box', icon: FolderOpen, color: '#0061d5', enabled: true,
  ...
  { 
    id: 'jira-cloud', name: 'Jira Cloud', icon: CheckSquare, color: '#0052cc', enabled: true,
  ...
  { 
    id: 'jira-dc', name: 'Jira Data Center', icon: CheckSquare, color: '#0052cc', enabled: true,
  ...
  { 
    id: 'confluence-cloud', name: 'Confluence Cloud', icon: FileText, color: '#0052cc', enabled: true,
  ...
  { 
    id: 'confluence-dc', name: 'Confluence Data Center', icon: FileText, color: '#0052cc', enabled: true,
  ...
  { 
    id: 'dropbox', name: 'Dropbox', icon: FolderOpen, color: '#0061d5', enabled: true,
  ...
  { 
    id: 'linear', name: 'Linear', icon: CheckSquare, color: '#5e6ad2', enabled: true,
  ...
  { 
    id: 'monday', name: 'Monday.com', icon: Calendar, color: '#ff3d57', enabled: true,
  ...
  { 
    id: 'hubspot', name: 'HubSpot', icon: Users, color: '#ff7a59', enabled: true,
  ...
  { 
    id: 'shopify', name: 'Shopify', icon: ShoppingBag, color: '#96bf48', enabled: true,
  ...
  { 
    id: 'notion', name: 'Notion', icon: FileText, color: '#000000', enabled: true,
  ...
  { 
    id: 'outlook', name: 'Outlook', icon: Mail, color: '#0078d4', enabled: true,
  ...
  { 
    id: 'onedrive', name: 'Microsoft OneDrive', icon: FolderOpen, color: '#0078d4', enabled: true,
    syncs: ['Files', 'Folders'],
  ...
  { 
    id: 'sharepoint', name: 'Microsoft SharePoint', icon: FileText, color: '#0078d4', enabled: true,
  ...
  { 
    id: 'teams', name: 'Microsoft Teams', icon: MessageSquare, color: '#555a99', enabled: true,
  ...
  { 
    id: 'servicenow', name: 'ServiceNow', icon: Server, color: '#81b5a1', enabled: true,
  ...
  { 
    id: 'zendesk', name: 'Zendesk', icon: MessageCircle, color: '#03363d', enabled: true,
  ...
  { 
    id: 'entra-id', name: 'Microsoft Entra ID', icon: Users, color: '#0078d4', enabled: true,
  ...
  { 
    id: 'asana', name: 'Asana', icon: CheckSquare, color: '#fc636b', enabled: true,
  ...
  { 
    id: 'pagerduty', name: 'PagerDuty', icon: Activity, color: '#06ac38', enabled: true,
  ...
  { 
    id: 'wrike', name: 'Wrike', icon: FileText, color: '#04a85b', enabled: true,
  ...
  { 
    id: 'zohobooks', name: 'Zoho Books', icon: CreditCard, color: '#e2231a', enabled: true,
  ...
  { 
    id: 'zohodesk', name: 'Zoho Desk', icon: HelpCircle, color: '#2277bb', enabled: true,
  ...
  { 
    id: 'zohoprojects', name: 'Zoho Projects', icon: Briefcase, color: '#f39200', enabled: true,
  ...
  {
    id: 'apollo-graphos', name: 'Apollo GraphOS', icon: Database, color: '#e535ab', enabled: true,
  ...
  {
    id: 'blockscout', name: 'Blockscout', icon: Database, color: '#3c3c3d', enabled: true,
  ...
  {
    id: 'dice', name: 'Dice', icon: Search, color: '#1a5ba8', enabled: true,
  ...
  {
    id: 'clinicaltrials', name: 'Clinical Trials', icon: Activity, color: '#007bbf', enabled: true,
  ...
  {
    id: 'crossbeam', name: 'Crossbeam', icon: Users, color: '#ff5a5f', enabled: true,
  ...
  {
    id: 'crypto', name: 'Crypto', icon: CreditCard, color: '#f7931a', enabled: true,
  ...
  {
    id: 'docusign', name: 'DocuSign', icon: FileText, color: '#ffb500', enabled: true,
  ...
  {
    id: 'excalidraw', name: 'Excalidraw', icon: FileText, color: '#6965db', enabled: true,
  ...
  {
    id: 'granted', name: 'Granted', icon: Server, color: '#2563eb', enabled: true,
  ...
  {
    id: 'godaddy', name: 'GoDaddy', icon: Server, color: '#00a650', enabled: true,
  ...
  {
    id: 'huggingface', name: 'Hugging Face', icon: Database, color: '#ffd21e', enabled: true,
  ...
  {
    id: 'invideo', name: 'Invideo', icon: FileText, color: '#0052cc', enabled: true,
  ...
  {
    id: 'kiwi', name: 'Kiwi', icon: Calendar, color: '#00a699', enabled: true,
  ...
  {
    id: 'lastminute', name: 'LastMinute', icon: Calendar, color: '#ff4f00', enabled: true,
  ...
  {
    id: 'mermaid_chart', name: 'Mermaid Chart', icon: FileText, color: '#ff3366', enabled: true,
  ...
  {
    id: 'midpage', name: 'Midpage', icon: FileText, color: '#6200ee', enabled: true,
  ...
  {
    id: 'microsoft-learn', name: 'Microsoft Learn', icon: BookOpen, color: '#00a4ef', enabled: true,
  ...
  {
    id: 'open_targets', name: 'Open Targets', icon: Activity, color: '#3f51b5', enabled: true,
  ...
  {
    id: 'pandadoc', name: 'PandaDoc', icon: FileText, color: '#00d084', enabled: true,
  ...
  {
    id: 'smartsheet', name: 'Smartsheet', icon: FileText, color: '#24a148', enabled: true,
  ...
  {
    id: 'trivago', name: 'Trivago', icon: Search, color: '#007faf', enabled: true,
  ...
  {
    id: 'salesforce', name: 'Salesforce', icon: Cloud, color: '#00a1e0', enabled: true,
  ...
  {
    id: 's3', name: 'Amazon S3', icon: HardDrive, color: '#FF9900', enabled: true,
  ...
  {
    id: 'azure-blob', name: 'Azure Blob Storage', icon: HardDrive, color: '#0078d4', enabled: true,
  ...
  {
    id: 'bitbucket', name: 'Bitbucket', icon: Github, color: '#0052cc', enabled: true,
  ...
  { 
    id: 'drive', name: 'Google Drive', icon: FolderOpen, color: '#f4b400', enabled: true,
  ...
  { 
    id: 'gmail', name: 'Gmail', icon: Mail, color: '#ea4335', enabled: true,
  ...
  { 
    id: 'gcal', name: 'Google Calendar', icon: Calendar, color: '#4285f4', enabled: true,
  ...
  { 
    id: 'gchat', name: 'Google Chat', icon: MessageCircle, color: '#00ac47', enabled: true,
  ...
  { 
    id: 'bigquery', name: 'BigQuery', icon: Database, color: '#669df6', enabled: true,
  ...
  { 
    id: 'gcs', name: 'Cloud Storage', icon: HardDrive, color: '#4285f4', enabled: true,
    syncs: ['Buckets', 'Objects', 'Metadata'],
    actions: [],
    permissions: 'OAuth 2.0 (Service Account / User)',
  ...
  { 
    id: 'gsearch', name: 'Google Search', icon: Search, color: '#4285f4', enabled: true,
    syncs: ['Web Pages', 'Knowledge Graph'],
    actions: [],
    permissions: 'API Key / Search Engine ID'
  },
  {
    id: 'groups', name: 'Google Groups', icon: Users, color: '#1a73e8', enabled: true,
  ...
  {
    id: 'notebooklm', name: 'NotebookLM', icon: BookOpen, color: '#0f9d58', enabled: true,
  ...
  {
    id: 'cloudsql', name: 'Cloud SQL', icon: Database, color: '#4285f4', enabled: true,
  ...
  {
    id: 'spanner', name: 'Spanner', icon: Database, color: '#4285f4', enabled: true,
    syncs: ['Databases', 'Tables', 'Schemas'],
    actions: [],
    permissions: 'OAuth 2.0 (Service Account / User)',
  ...
  {
    id: 'firestore', name: 'Firestore', icon: Database, color: '#ffca28', enabled: true,
  ...
  {
    id: 'bigtable', name: 'Bigtable', icon: Database, color: '#4285f4', enabled: true,
  ...
  {
    id: 'alloydb', name: 'AlloyDB', icon: Database, color: '#4285f4', enabled: true,
    syncs: ['Databases', 'Tables', 'Schemas'],
    actions: [],
    permissions: 'OAuth 2.0 (Service Account / User)',
...
export const CONNECTOR_LIST = (() => {
  const envDisabledStr = import.meta.env.VITE_DISABLED_CONNECTORS || '';
  const envDisabled = envDisabledStr
    .split(',')
  ...
  return ALL_CONNECTORS.filter(c => {
    ...
    if (envDisabled.includes(c.id.toLowerCase())) return false;
    return true;
  });
})();
